...
export default function Home() {
  <style> @import url(&quot https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800;900&display=swap &quot); </style>
      ...
      <div className={styles.main}>
        <div className={styles.container}>
          <h1 className={styles.title}>
            Welcome to LearnWeb3 Punks, <span> {ens ? ens : address}</span> !
          </h1>
        ...
        <div>
          <img className={styles.image} src="./learnweb3punks.png" alt="image" layout="fill"/>
        </div>
      </div>

      <footer className={styles.footer}>
        Made with &#10084; by &nbsp;<a href="https://twitter.com/0xrishavsharma">rishavsharma.eth</a>
      </footer>
    </div>
  );
}
